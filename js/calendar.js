...
var currentYear = todayString.substr(0,4);
 var currentMonth = todayString.substr(5,2);
 if (currentMonth.substr(0,1) == "0" ){
   currentMonth = currentMonth.substr(1,1);
 }

var phpGetDay = document.getElementById("dayforjs").value;
var selectedMonth = phpGetDay.substr(5,2);
var selectedYear = phpGetDay.substr(0,4);
if(currentYear < selectedYear){
  var diff = selectedYear - currentYear
  for (var i = 0; i < diff*12; i++) {
    toNextMonth();
  }
}
if(currentYear > selectedYear){
...
if (selectedMonth.substr(0,1) == 0){
  selectedMonth = selectedMonth.substr(1,1);
}

if(currentMonth > selectedMonth){
  var dif = currentMonth - selectedMonth;
  for (var i = 0; i<dif; i++){
    toPrevMonth();
  }
}
if (selectedMonth - currentMonth > 0) {

  var dif = selectedMonth - currentMonth;
  for (var i = 0; i<dif; i++){
    toNextMonth();
  }
}
